...
0.2.4 adds the Carrier Trade Calculator and groups carrier-focused tools under a new `Carrier Tools` top navigation menu. The calculator includes station-to-station trade splitting and rare commodity carrier sale calculations with live carrier/hauler profit outputs.
